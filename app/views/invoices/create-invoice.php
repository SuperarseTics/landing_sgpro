...
<body class="bg-gray-100 font-sans">
    ...
    <div class="ml-64 p-8">
        <header class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Crear Nueva Factura</h1>
        </header>

        <main class="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto">
            <form action="<?php echo BASE_PATH; ?>/invoices/store" method="POST" enctype="multipart/form-data" class="space-y-4">
                <div>
                ...
                <div>
                    ...
                    <input type="number" id="amount" name="amount" step="0.01" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md">
                </div>
                <div>
                ...
                <div>
                    <label for="payment_proof" class="block text-sm font-medium text-gray-700">Comprobante de Pago</label>
