...
<body class="bg-gray-100 font-sans">
    ...
    <div class="ml-64 p-8">
        <header class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Asignaciones a Profesores</h1>
        </header>
                        ...
                        <?php foreach ($assignments as $assignment): ?>
                            <tr>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <?php echo htmlspecialchars($assignment['professor_id']); ?>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <?php echo htmlspecialchars($assignment['subject_id']); ?>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <?php echo htmlspecialchars($assignment['pao_id']); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
