...
<body class="bg-gray-100 font-sans">
    ...
    <div class="ml-64 p-8">
        ...
        <main class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-xl font-semibold mb-4">Evaluaciones Registradas</h2>
            <table class="min-w-full leading-normal">
                ...
                <tbody>
                        ...
                        <?php foreach ($evaluations as $evaluation): ?>
                            <tr>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <?php echo htmlspecialchars($evaluation['professor_id']); ?>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <?php echo htmlspecialchars($evaluation['pao_id']); ?>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <?php echo htmlspecialchars($evaluation['score']); ?>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="text-center py-4 text-gray-500">No hay evaluaciones registradas.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
