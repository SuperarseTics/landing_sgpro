...
<body class="bg-gray-100 font-sans">
    ...
    <div class="ml-64 p-8">
        ...
        <main class="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto">
            <form action="<?php echo BASE_PATH; ?>/contracts/store" method="POST" class="space-y-4" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <label for="document" class="block text-sm font-medium text-gray-700">Documento (Opcional)</label>
                    <input type="file" id="document" name="document" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                </div>
